export default {
  ...
  description: {
    ...
    ru: 'Орда Vanguard стремится к традиции, структуру и порядок в обществе. Их крепость может быть найдена в пышной зеленой зоне около Guardstone.',
    ...
    zh: 'Vanguard部落尋求的是社會的傳統，結構和秩序。 他們的城堡位於Guardstone周圍鬱鬱蔥蔥的綠色區域。'
  }
}
